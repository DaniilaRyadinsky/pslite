...
{
    public sealed class ImageLayer : Control
    {
        ...
        public ImageLayer(SoftwareBitmap referense, string filename, BitmapDecoder decoder)
        {
            this.DefaultStyleKey = typeof(ImageLayer);
            Referense = referense;
            Text = filename;
            makeIcon(decoder);
        }

        private bool disposedValue; // Чтобы отслеживать, был ли объект уже освобожден
        ...
        private async void makeIcon(BitmapDecoder decoder)
        {
            ...
            Icon = icon;
            var iconSource = new SoftwareBitmapSource();
        ...
        protected override void OnApplyTemplate()
        {
            ...
            var image = GetTemplateChild("Thumbnail") as Microsoft.UI.Xaml.Controls.Image;
